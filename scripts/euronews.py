...
for article in articles:
    ...
    try:
        ...
        # Get Image HTML Tag
        img = articleSoup.find(
            "img",
            "js-poster-img c-article-media__img u-max-height-full u-width-full"
        )
        ...
        if img is None:
            ...
            storage_link = ("https://firebasestorage.googleapis.com/"
                            "v0/b/news-a3e22.appspot.com/o/Euronews%2F"
                            "euronews.jpg?alt=media&token="
                            "a1edaad7-50f2-400f-bbbf-e89d56b7c9ee")
            ...
            if title not in ref_list and check is False:
                ...
                # Using Utils method
                pushToDB(db_path, title, date, link,
            ...
            if title not in ref_list and check is False:
                ...
                with open(f"{img_path}/{img_title}", "wb") as img:
                    ...
                    storage_link = (f"https://firebasestorage.googleapis.com/"
                                    f"v0/b/news-a3e22.appspot.com/o/Euronews"
                                    f"%2F{td}%2F{img_title}?alt=media&"
                                    f"token={token}")
