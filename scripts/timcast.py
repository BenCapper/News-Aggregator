...
from utils import titleFormat
from utils import logFolder, logFile, initialise, pageSoup, imgTitleFormat, titleFormat, imgFolder, pushToDB
...
for article in articles:
   ...
   if title not in ref_list:
       ...
       pushToDB(db_path,title,found_date,author,first_line,img_link,img_title,link,outlet, storage_link)
