...
for article in articles:
    ...
    title = img_list[0][10:-1].replace("%", "pc").replace(":", " ")
    ...
    if title not in ref_list:
        ...
        storage_link = f"https://firebasestorage.googleapis.com/v0/b/news-a3e22.appspot.com/o/Timcast%2F{img_title}?alt=media&token={token}"
