...
json_dump_path = "/home/bencapper/src/News-Aggregator/scripts/json/blaze.json"
json_folder_path = "/home/bencapper/src/News-Aggregator/scripts/json/"
json_path = "/home/bencapper/src/News-Aggregator/scripts/news.json"
db_url = "https://news-a3e22-default-rtdb.firebaseio.com/"
bucket = "news-a3e22.appspot.com"
page_url = "https://theblaze.com/"
img_path = f"/home/bencapper/src/News/Blaze/{td}"
...
for article in articles:
    ...
    try:
        ...
        urls = list()
        for art in a:
            url = (str(art).split(' href="')[1]
                   .split('">')[0].split('" target')[0])
            if "bit.ly" in url:
                pass
            elif "podcast" in url:
                pass
            ...
            if d is None:
                ...
                if title not in ref_list and check is False:
                    ...
                    with open(f"{img_path}/{img_title}", "wb") as img:
                        ...
                        blob = bucket.blob(f"Blaze/{td}/{img_title}")
                        token = uuid4()
                    ...
                    storage_link = (
                                    ...
                                    f"v0/b/news-a3e22.appspot.com/o/"
                                    f"Blaze%2F{td}%2F{img_title}?"
