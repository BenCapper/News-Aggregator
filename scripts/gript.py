...
json_dump_path = "/home/bencapper/src/News-Aggregator/scripts/json/gript.json"
...
for article in articles:
    ...
    try:
        ...
        # Get Article Link
        url = article.split(' post-url="')[1].split('/">')
        [0].split('" secondary')[0]
        ...
        if title not in ref_list and check is False:
            ...
            if img_link == "":
                ...
                storage_link = ("https://firebasestorage.googleapis.com/"
                                "v0/b/news-a3e22.appspot.com/o/Gript%2F"
                                "gript.png?alt=media&token=bfd4ac07-"
                                "e089-4007-a3db-1bff3a932093")
            ...
            # Image Available
                ...
                storage_link = (f"https://firebasestorage.googleapis.com"
                                f"/v0/b/news-a3e22.appspot.com/o/Gript%"
                                f"2F{td}%2F{img_title}?alt"
                                f"=media&token={token}")
