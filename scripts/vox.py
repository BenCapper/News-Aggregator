        ...
        if "404 Not" in str(title):
            ...
            if img_src == "ad":
                ...
                if dates == []:
                    ...
                    dates = str(dates).split('datetime="')
                    [1].split("T")[0].split("-")
                    date = list()
                    date.append(dates[2])
                    date.append(dates[1])
                    ...
                    if title not in ref_list and check is False:
                        ...
                        storage_link = ("https://firebasestorage."
                                        "googleapis.com/v0/b/news-a3e22."
                                        "appspot.com/o/Vox%2Fvox.png?alt"
                                        "=media&token=db1c46f1-1155-44fa-"
                                        "b0aa-61d0b992da21")
