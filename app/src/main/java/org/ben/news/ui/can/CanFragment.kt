...
class CanFragment : Fragment(), StoryListener, MenuProvider {

    companion object {
        fun newInstance() = CanFragment()
    }

    private var _fragBinding: FragmentCanBinding? = null
    ...
    override fun onCreateView(
        ...
        activity?.findViewById<ImageView>(R.id.toolimg)?.setImageResource(R.drawable.ca)
        MobileAds.initialize(this.requireContext()) {}
        val fab = activity?.findViewById<FloatingActionButton>(R.id.fab)
        val bot = activity?.findViewById<BottomNavigationView>(R.id.bottom_nav)
        fab?.visibility = View.INVISIBLE
        fragBinding.recyclerViewCan.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            var y = 0
        ...
        canViewModel.observableCanList.observe(viewLifecycleOwner) { story ->
            story?.let {
