...
class RteFragment : Fragment(), StoryListener, MenuProvider {

    companion object {
        fun newInstance() = RteFragment()
    }

    private var _fragBinding: FragmentRteBinding? = null
    ...
    override fun onCreateView(
        ...
        fragBinding.recyclerViewRte.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            var y = 0
        ...
        fab!!.setOnClickListener {
            fragBinding.recyclerViewRte.smoothScrollToPosition(0)
