...
import org.ben.news.databinding.FragmentGuardBinding
...
class GuardFragment : Fragment(), StoryListener, MenuProvider {

    companion object {
        fun newInstance() = GuardFragment()
    }

    private var _fragBinding: FragmentGuardBinding? = null
    ...
    override fun onCreateView(
        ...
        fragBinding.recyclerViewGua.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            var y = 0
        ...
        fab!!.setOnClickListener {
            fragBinding.recyclerViewGua.smoothScrollToPosition(0)
            bot!!.visibility = View.VISIBLE
        }

        guardViewModel.observableGuardList.observe(viewLifecycleOwner) { story ->
            story?.let {
    ...
    private fun render(storyList: ArrayList<StoryModel>) {
        fragBinding.recyclerViewGua.adapter = StoryAdapter(storyList, this)
        state?.let { fragBinding.recyclerViewGua.layoutManager?.onRestoreInstanceState(it) }
    }
