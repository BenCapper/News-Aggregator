...
class CbsFragment : Fragment(), StoryListener, MenuProvider {
    ...
    override fun onCreateView(
        ...
        fragBinding.recyclerViewCbs.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            var y = 0
        ...
        fab!!.setOnClickListener {
            fragBinding.recyclerViewCbs.smoothScrollToPosition(0)
