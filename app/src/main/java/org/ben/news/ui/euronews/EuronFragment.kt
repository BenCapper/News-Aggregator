...
class EuronFragment : Fragment(), StoryListener, MenuProvider {

    companion object {
        fun newInstance() = EuronFragment()
    }

    private var _fragBinding: FragmentEuronBinding? = null
    ...
    override fun onCreateView(
        ...
        fragBinding.recyclerViewEu.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            var y = 0
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        menuHost.addMenuProvider(this, viewLifecycleOwner, State.RESUMED)
    }
