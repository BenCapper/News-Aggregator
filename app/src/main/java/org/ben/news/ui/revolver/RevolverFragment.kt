...
class RevolverFragment : Fragment(), StoryListener, MenuProvider {
    ...
    override fun onCreateView(
        ...
        revViewModel.observableRevList.observe(viewLifecycleOwner) { story ->
            ...
            hideLoader(loader)
            if (fragBinding.recyclerViewRev.adapter!!.itemCount == 0 && searching != null) {
            ...
            } else if (fragBinding.recyclerViewRev.adapter!!.itemCount == 0) {
