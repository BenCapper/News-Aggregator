...
class ZerohedgeFragment : Fragment(), StoryListener, MenuProvider {
    ...
    override fun onCreateView(
        ...
        fragBinding.recyclerViewZero.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            var y = 0
        ...
        fab!!.setOnClickListener {
            fragBinding.recyclerViewZero.smoothScrollToPosition(0)
