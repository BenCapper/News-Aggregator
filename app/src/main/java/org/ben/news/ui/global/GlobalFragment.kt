...
class GlobalFragment : Fragment(), StoryListener, MenuProvider {
    ...
    override fun onCreateView(
        ...
        activity?.findViewById<ImageView>(R.id.toolimg)?.setImageResource(R.drawable.glob)
        MobileAds.initialize(this.requireContext()) {}
        val fab = activity?.findViewById<FloatingActionButton>(R.id.fab)
        val bot = activity?.findViewById<BottomNavigationView>(R.id.bottom_nav)
        fab?.visibility = View.INVISIBLE
        fragBinding.recyclerViewGlo.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            var y = 0
