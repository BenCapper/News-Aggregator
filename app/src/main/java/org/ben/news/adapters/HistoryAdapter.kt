...
import org.ben.news.databinding.CardHistoryBinding
import org.ben.news.models.StoryModel
import timber.log.Timber
import kotlin.math.roundToInt


class HistoryAdapter constructor(private var stories: ArrayList<StoryModel>, private val listener: StoryListener, )
    ...
    inner class MainHolder(private val binding: CardHistoryBinding) : RecyclerView.ViewHolder(binding.root) {
